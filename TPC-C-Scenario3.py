...
# Dataset file
authoritative_dataset_filename = "Datasets/tpcc_gpu1_20170725.csv"
unknown_dataset_filename = "Datasets/tpcc_gateway_20170725.csv"
...
# -----------------------------------------------------------------------------------------------------------------
#
# TPC-C Scenario 3 - Modeling the effects of downgrading the system (GPU server -> gateway)
#
# -----------------------------------------------------------------------------------------------------------------

experiment_tpcc_3 = ModelMapExperiment.ModelMapExperiment(
    ...
    logger=logger,
    title="TPC-C-Scenario3-"
)

# Run the experiments

experiment_tpcc_3.run()
