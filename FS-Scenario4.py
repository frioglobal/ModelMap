...
domain_columns = ["workload_id", "machine_id", "block_size", "bg_count", "inode_size"]
...
# -----------------------------------------------------------------------------------------------------------------
#
# Filesystem Scenario 4 - Modeling the effects of disk type (SATA -> SSD) and I/O scheduler (CFQ -> noop)
#
# -----------------------------------------------------------------------------------------------------------------

Filesystem_Experiment_4 = ModelMapExperiment.ModelMapExperiment(
