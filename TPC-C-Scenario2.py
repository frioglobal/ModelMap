...
# -----------------------------------------------------------------------------------------------------------------
#
# TPC-C Scenario 2 - Modeling the effects of downgrading the system (blade -> gateway)
#
# -----------------------------------------------------------------------------------------------------------------

experiment_tpcc_2 = ModelMapExperiment.ModelMapExperiment(
    ...
    logger=logger,
    title="TPC-C-Scenario2-"
)

# Run the experiments

experiment_tpcc_2.run()
